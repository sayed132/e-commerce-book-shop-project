                    ...
                    <fieldset className="grid grid-cols-5  items-start gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
                        ...
                        <div className="col-span-full">
                            <div className="grid grid-cols-8 gap-4">
                                ...
                                <div className="col-span-full lg:col-span-2 my-6 lg:my-0">
                                    <div className="relative   h-36 rounded-lg bg-gradient-to-t from-blue-600 to-blue-400 flex items-center justify-start">
                                        <p className="absolute -top-8 right-0 text-7xl text-blue-300">
                                            <GiSurferVan></GiSurferVan>
                                        </p>
                                        <div className="text-start p-4 text-white">
                                            <h2 className="text-3xl font-bold">3700</h2>
                                            <p className="">Shipped Orders</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-full lg:col-span-2 my-6 lg:my-0">
                                    <div className="relative   h-36 rounded-lg bg-gradient-to-t from-green-500 to-green-400 flex items-center justify-start">
                                        <p className="absolute -top-6 right-0 text-6xl text-green-200">
                                            <BsBagCheckFill></BsBagCheckFill>
                                        </p>
                                        <div className="text-start p-4 text-white">
                                            <h2 className="text-3xl font-bold">900</h2>
                                            <p className="">Received Orders</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-full lg:col-span-2 my-6 lg:my-0">
                                    <div className="relative   h-36 rounded-lg bg-gradient-to-t from-red-500 to-red-400 flex items-center justify-start">
                                        <p className="absolute -top-6  right-0 text-6xl text-red-700">
                                        ...
                                        <div className="grid grid-cols-4 gap-4 mx-4 ">
                                            ...
                                            <div className="space-y-2 form-control font-semibold  col-span-full  lg:col-span-1">
                                                ...
                                                >
                                                    ...
                                                    <option className={inputClass}>Shipped</option>
                                            ...
                                            <table className="min-w-full text-xs">
                                                ...
                                                <thead className="dark:bg-gray-700 ">
                                                    <tr className="bg-blue-600 text-white ">
                                                        ...
                                                        <th className="p-3 text-base  text-start uppercase font-semibold">Product</th>
                                                        <th className="p-3 text-base  text-start uppercase font-semibold">AMOUNT</th>
                                                        <th className="p-3 text-base  text-start uppercase font-semibold">Payment</th>
                                                        <th className="p-3 text-base  text-start uppercase font-semibold">STATUS</th>
                                                        <th className="p-3 text-base  text-start uppercase font-semibold">DATE time</th>
                                                    ...
                                                    {data.map((item) => (
                                                        <tr key={item.id} className="border-b text-start border-opacity-20 dark:border-gray-700 dark:bg-gray-900">
                                                            <td className="p-4 text-base font-bold">
                                                                <input type="checkbox" className=" checkbox-xs me-2" name="" id="" />{item.uid}
                                                            </td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.clientName}</td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.product}</td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.amount}</td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.payment}</td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.status}</td>
                                                            <td className="p-4 text-base font-semibold text-gray-700 dark:text-gray-300">{item.date}</td>
